...
public class CustomOffersPage extends TestBase1{


	public CustomOffersPage() {
	super();
	}
...
//	public PublicFormRailOnePage newTab() throws Exception  {
//		Thread.sleep(7000);
//	       driver.navigate().to("https://demo.fitsyn.com/dashboard");
//	       driver.manage().window().maximize();
//	       Thread.sleep(7000);
//	       return new PublicFormRailOnePage(driver);
//	 
//	}
